...
from habits.validators import (validate_related_habit_and_reward,
                               ...
                               validate_nice_habit_no_reward_or_related,
...
class Habit(models.Model):
    ...
    is_nice_habit = models.BooleanField(verbose_name='приятность привычки',
                                        **NULLABLE)
    ...
    last_reminder = models.DateTimeField(
        verbose_name='дата последнего напоминания', **NULLABLE)
